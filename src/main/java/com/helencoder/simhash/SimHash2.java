...
public class SimHash2 {
     ...
     * @return
     */
    public List<BigInteger> subByDistance(SimHash2 simHash, int distance){
    ...
    public static void main(String[] args) {
        SimHash2 hash = new SimHash2("Aa01A01=", 64);
        System.out.println(hash.strSimHash);
        SimHash2 hash10 = new SimHash2("Aa01A01@", 64);
        System.out.println(hash10.strSimHash);
