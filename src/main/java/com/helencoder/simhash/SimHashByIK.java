 ...
 *
 *
 * Created by zhenghailun on 2017/10/30.
 */
public class SimHashByIK {
    private String tokens;
    private BigInteger intSimHash;
    private String strSimHash;
    private int hashbits = 64;

    public SimHashByIK(String tokens) throws IOException {
        this.tokens = tokens;
        this.intSimHash = this.simHash();
    }

    public SimHashByIK(String tokens, int hashbits) throws IOException {
        this.tokens = tokens;
    ...
    public int hammingDistance(SimHashByIK other) {
    ...
    public List subByDistance(SimHashByIK simHash, int distance) {
        // 分成几组来检查
    ...
    public static void main(String[] args) throws IOException {
        ...
        SimHashByIK hash1 = new SimHashByIK(s, 64);
        ...
        SimHashByIK hash2 = new SimHashByIK(s, 64);
        ...
        SimHashByIK hash3 = new SimHashByIK(s, 64);
