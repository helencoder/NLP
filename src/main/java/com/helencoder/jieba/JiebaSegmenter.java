...
public class JiebaSegmenter {
    ...
    public JiebaSegmenter(String main_dictPath,String user_dictPath,String prob_emitPath){
        this.wordDict = WordDictionary.getInstance(main_dictPath,user_dictPath);
        this.finalSeg = FinalSeg.getInstance(prob_emitPath);
    }
