...
class DictSegment implements Comparable<DictSegment> {
    ...
    private static final int NUMBER_OF_HASHMAP = 2;
    private static final float FLOAT_OF_HASHMAP = 0.8f;
    ...
    private Map<Character, DictSegment> getChildrenMap() {
        if (this.childrenMap == null) {
            synchronized (this) {
                if (this.childrenMap == null) {
                    this.childrenMap = new HashMap<Character, DictSegment>(ARRAY_LENGTH_LIMIT * NUMBER_OF_HASHMAP, FLOAT_OF_HASHMAP);
                }
            }
        }
    ...
    public boolean equals(Object o) {
        if (o == null || !(o instanceof DictSegment)) {
            return false;
        }
        DictSegment other = (DictSegment)o;
