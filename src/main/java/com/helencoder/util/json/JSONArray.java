...
public class JSONArray {
    ...
    public JSONArray(Object var1, boolean var2) throws JSONException {
        ...
        if(!var1.getClass().isArray()) {
            ...
            for(int var4 = 0; var4 < var3; ++var4) {
                this.put((Object)(new JSONObject(Array.get(var1, var4), var2)));
            }
    ...
    String toString(int var1, int var2) throws JSONException {
        ...
        if(var3 == 0) {
            ...
            if(var3 == 1) {
                var4.append(JSONObject.valueToString(this.myArrayList.get(0), var1, var2));
            } else {
                int var5 = var2 + var1;
                var4.append('\n');
                ...
                for(var6 = 0; var6 < var3; ++var6) {
                    ...
                    var4.append(JSONObject.valueToString(this.myArrayList.get(var6), var1, var5));
                }
