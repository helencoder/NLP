...
public class JSONObject {
    ...
    public JSONObject(Map var1, boolean var2) {
        ...
        if(var1 != null) {
            ...
            while(var3.hasNext()) {
                ...
                this.map.put(var4.getKey(), new JSONObject(var4.getValue(), var2));
            }
        }
            ...
            try {
                ...
                if(var8.length() > 0 && Character.isUpperCase(var8.charAt(0)) && var6.getParameterTypes().length == 0) {
                    ...
                    if(var9 == null) {
                        ...
                        this.map.put(var8, new JSONArray(var9, var2));
                    } else if(var9 instanceof Collection) {
                        this.map.put(var8, new JSONArray((Collection)var9, var2));
                    } else if(var9 instanceof Map) {
                        this.map.put(var8, new JSONObject((Map)var9, var2));
                        ...
                        this.map.put(var8, new JSONObject(var9, var2));
                    } else {
    ...
    public double getDouble(String var1) throws JSONException {
        ...
        try {
            return var2 instanceof Number?((Number)var2).doubleValue():Double.valueOf((String)var2).doubleValue();
    ...
    public static String quote(String var0) {
        if(var0 != null && var0.length() != 0) {
            ...
            for(int var4 = 0; var4 < var2; ++var4) {
                ...
                if(var1 >= 32 && (var1 < 128 || var1 >= 160) && (var1 < 8192 || var1 >= 8448)) {
                    var3.append(var1);
                } else {
    ...
    public static Object stringToValue(String var0) {
        if(var0.equals("")) {
            ...
            if(var1 >= 48 && var1 <= 57 || var1 == 46 || var1 == 45 || var1 == 43) {
                if(var1 == 48) {
                    if(var0.length() > 2 && (var0.charAt(1) == 120 || var0.charAt(1) == 88)) {
                        try {
    ...
    String toString(int var1, int var2) throws JSONException {
        ...
        if(var3 == 0) {
            ...
            if(var3 == 1) {
                ...
                var5.append(": ");
                var5.append(valueToString(this.map.get(var7), var1, var2));
            } else {
                while(true) {
                    int var8;
                    if(!var4.hasNext()) {
                    ...
                    var5.append(quote(var7.toString()));
                    var5.append(": ");
                    var5.append(valueToString(this.map.get(var7), var1, var6));
                }
            }
